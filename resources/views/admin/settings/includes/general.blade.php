<div class="tile">
    <form action="{{ route('admin.settings.update') }}" method="POST" role="form">
        ...
        <div class="tile-body">
            ...
            <div class="form-group">
                <label class="control-label" for="default_phone">Default Phone Number</label>
                <input
                    class="form-control"
                    type="text"
            ...
            <div class="form-group">
                <label class="control-label" for="minimum">Minimum Orders ($)</label>
                <input
                    class="form-control"
                    type="text"
                    placeholder="Enter minimum Ammount To order"
                    id="minimum"
                    name="minimum"
                    value="{{ config('settings.minimum') }}"
                />
            </div>
            <div class="form-group">
                ...
                <input
                    class="form-control"
                    type="text"
                    placeholder="Enter the percentage of Tax"
                    id="tax"
                    name="tax"
                    value="{{ config('settings.tax') }}"
                />
            </div>
            <div class="form-group">
                <label class="control-label" for="regular">Regular Delivery Charge</label>
                <input
                    class="form-control"
                    type="text"
                    placeholder="Enter the Regular Delivery Charge"
                    id="regular"
                    name="regular"
                    value="{{ config('settings.regular') }}"
                />
            </div>
            <div class="form-group">
                <label class="control-label" for="nextday">Next Day Delivery Charge</label>
                <input
                    class="form-control"
                    type="text"
                    placeholder="Enter the Next Day Delivery Charge"
                    id="nextday"
                    name="nextday"
                    value="{{ config('settings.nextday') }}"
                />
            </div>
        </div>
