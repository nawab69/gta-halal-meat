...
@section('content')
    <div class="app-title">
        <div>
            <h1><i class="fa fa-briefcase"></i> Edit Coupon</h1>
        </div>
    </div>
                ...
                <form action="{{ route('admin.coupons.update') }}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-body"><div class="tile-body">
                            ...
                            <div class="form-group" id="dvalue">
                                ...
                                <input type="text" name="value" class="form-control" id="value" value="0">
                            </div>
                            <div class="form-group" id="dpercent">
                                ...
                                <input type="text" name="percent" class="form-control" id="percent" value="0">
                            </div>
                        </div>
