...
@section('styles')
    <link rel="stylesheet" type="text/css" href="{{ asset('public/backend/js/plugins/dropzone/dist/min/dropzone.min.css') }}"/>
@endsection
@section('content')
                        ...
                        <form action="{{ route('admin.products.update') }}" method="POST" role="form" enctype="multipart/form-data">
                            ...
                            <div class="tile-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" >
                                            <label class="control-label" for="quantity">Quantity(In Weight)</label>
                                            <input
                                                class="form-control @error('quantity') is-invalid @enderror"
                                                type="number"
                                                placeholder="Enter product quantity (In Weight)"
                                                id="quantity"
                                                name="quantity"
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        @if ($product->image != null)
                                            <img src="{{ asset('public/storage/'.$product->image) }}" id="proImg" style="width: 80px; height: auto;">
                                        @else
                                            <img src="https://via.placeholder.com/80x80?text=Placeholder+Image" id="proImg" style="width: 80px; height: auto;">
                                        @endif
                                    </div>
                                    <div class="col-9">
                                        <div class="form-group">
                                            <label class="control-label">Product Image</label>
                                            <input class="form-control" type="file" name="image" onchange="loadFile(event,'proImg')"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
...
@push('scripts')
    ...
    <script type="text/javascript" src="{{ asset('public/backend/js/plugins/dropzone/dist/min/dropzone.min.js') }}"></script>
