                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                                <td class="esd-block-text es-p15t es-p15b" align="center">
                                                                    <div class="esd-text">
                                                                        <h2 style="color: #242424; font-size: 30px;"><strong>Your order has been declined. </strong></h2>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="esd-block-text es-p10l" align="center">
                                                                    <p style="color: #242424;">Hello there, We have declined your order. If you already pay for this order , it will be refunded as soon as possible. Thanks for Choosing GTA Halal Meat service and welcome again. If you have any suggestions about us, please let us know.</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="esd-block-button es-p15t es-p15b es-p10r es-p10l" align="center"><span class="es-button-border" style="border-radius: 20px; background: #191919 none repeat scroll 0% 0%; border-style: solid; border-color: #2cb543; border-width: 0px; padding: 15px; margin-top: 10px"><a href="{{route('site.pages.homepage')}}" class="es-button" target="_blank" style="border-radius: 20px; font-family: lucida sans unicode,lucida grande,sans-serif; font-weight: normal; text-decoration: none; font-size: 18px; border-width: 10px 35px; background: #191919 none repeat scroll 0% 0%; border-color: #191919; color: #ffffff;">Order Again</a></span></td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
                                                    </td>
