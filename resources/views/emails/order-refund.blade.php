                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                                <td class="esd-block-text es-p15t es-p15b" align="center">
                                                                    <div class="esd-text">
                                                                        <h2 style="color: #242424; font-size: 30px;"><strong>Your order has been Refunded. </strong></h2>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="esd-block-text es-p10l" align="center">
                                                                    <p style="color: #242424;">Hello there, We have refunded your order. Thanks for Choosing GTA Halal Meat service and welcome again. If you have any suggestions about us, please let us know.</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
